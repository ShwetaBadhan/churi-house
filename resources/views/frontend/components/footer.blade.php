            ...
            <div class="col-lg-4">
                ...
                <div class="about-footer">
                    ...
                    <div class="footer-logo">
                        <img src="images/logo/logo.png" style="width: 80px;" alt="">
                    </div>
                    <!-- Footer Logo End -->

                    <!-- About Footer Content Start -->
                    <div class="about-footer-content">
                        <p align="justify">Where great food meets great company. Experience authentic flavors, handcrafted beverages,
                            and moments worth sharing with family and friends.
                        </p>
                    </div>
