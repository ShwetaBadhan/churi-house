                ...
                <div class="col-lg-12">
                    ...
                    <div class="our-gallery-box">
                        ...
                        <div class="gallery-image wow fadeInUp">
                            <figure>
                                <img src="https://churihouse.com/wp-content/uploads/2024/12/CHURI-CAFEMOHALI-1_page-0012.jpg" alt="">
                            </figure>
                        ...
                        <div class="gallery-image wow fadeInUp" data-wow-delay="0.2s">
                            <figure>
                                <img src="https://churihouse.com/wp-content/uploads/2024/12/CHURI-CAFEMOHALI-1_page-0006.jpg" alt="">
                            </figure>
                            <div class="gallery-btn">
                                <a href="{{ route('our-gallery') }}"><img src="images/arrow-white.svg" alt=""></a>
                            </div>
                        ...
                        <div class="gallery-image wow fadeInUp" data-wow-delay="0.4s">
                            <figure>
                                <img src="https://churihouse.com/wp-content/uploads/2024/12/CHURI-CAFEMOHALI-1_page-0008.jpg" alt="">
                            </figure>
                            <div class="gallery-btn">
                                <a href="{{ route('our-gallery') }}"><img src="images/arrow-white.svg" alt=""></a>
                            </div>
