                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Step into Churi House, where every flavor tells a story of tradition, quality, and care. Our kitchen celebrates the timeless charm of Indian heritage, serving everything from flaky, golden parathas to our signature, soul-soothing chai. Each dish is lovingly prepared with authentic recipes, handpicked premium ingredients, and the wholesome richness of pure desi ghee.</p>
                            <p class="wow fadeInUp" data-wow-delay="0.4s">Indulge in an experience that bridges the gap between comfort and creativity — whether it’s street-style favorites reimagined, hearty wraps packed with flavor, decadent pastas, or our artisanal wood-fired pizzas crafted in-house. At Churi House, every bite is a celebration of heritage, every sip a warm embrace.</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="about-btn wow fadeInUp" data-wow-delay="0.6s">
                            <a href="{{ route('about-us') }}" class="btn-default">More about us</a>
                        </div>
                        <!-- About Button End -->   
                    </div>
